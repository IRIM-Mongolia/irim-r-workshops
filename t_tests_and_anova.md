...
[32m✔[0m microbenchmark 1.5.0                     [62 kB in 0.4s]
[32m✔[0m numDeriv 2016.8-1.1                      [76 kB in 0.4s]
[32m✔[0m abind 1.4-8                              [22 kB in 0.4s]
[32m✔[0m reformulas 0.4.4                         [85 kB in 0.4s]
[32m✔[0m pbkrtest 0.5.5                           [77 kB in 0.4s]
[32m✔[0m Formula 1.2-5                            [128 kB in 0.4s]
[32m✔[0m rstatix 0.7.3                            [417 kB in 0.41s]
[32m✔[0m Rdpack 2.6.6                             [379 kB in 0.41s]
[32m✔[0m Deriv 4.2.0                              [39 kB in 7.4s]
[32m✔[0m forecast 9.0.2                           [591 kB in 0.41s]
[32m✔[0m SparseM 1.84-2                           [553 kB in 0.42s]
[32m✔[0m MatrixModels 0.5-4                       [25 kB in 16s]
[32m✔[0m minqa 1.2.8                              [55 kB in 16s]
[32m✔[0m rbibutils 2.4.1                          [1.2 MB in 0.43s]
[32m✔[0m cowplot 1.2.0                            [1.6 MB in 0.43s]
[32m✔[0m RcppEigen 0.3.4.0.2                      [1.8 MB in 0.44s]
[32m✔[0m corrplot 0.95                            [3.7 MB in 0.45s]
[32m✔[0m doBy 4.7.1                               [4.5 MB in 0.45s]
[32m✔[0m car 3.1-5                                [379 kB in 42s]
[32m✔[0m lme4 2.0-1                               [3.7 MB in 0.46s]
[32m✔[0m fracdiff 1.5-4                           [60 kB in 38s]
[32m✔[0m urca 1.3-4                               [681 kB in 47s]
[32m✔[0m nloptr 2.2.1                             [2.3 MB in 59s]
[32m✔[0m colorspace 2.1-2                         [2.1 MB in 59s]
[32m✔[0m carData 3.0-6                            [996 kB in 46s]
[32m✔[0m timeDate 4052.112                        [367 kB in 44s]
[32m✔[0m quantreg 6.1                             [925 kB in 43s]
[32m✔[0m lmtest 0.9-40                            [230 kB in 82s]
[32m✔[0m zoo 1.8-15                               [806 kB in 0.14s]
Successfully downloaded 29 packages in 0.88 seconds.

# Installing packages --------------------------------------------------------
[32m✔[0m abind 1.4-8                              [built from source in 8.4s]
[32m✔[0m carData 3.0-6                            [built from source in 11s]
[32m✔[0m corrplot 0.95                            [built from source in 11s]
[32m✔[0m Formula 1.2-5                            [built from source in 7.5s]
[32m✔[0m Deriv 4.2.0                              [built from source in 16s]
[32m✔[0m fracdiff 1.5-4                           [built from source in 16s]
[32m✔[0m colorspace 2.1-2                         [built from source in 39s]
[32m✔[0m microbenchmark 1.5.0                     [built from source in 16s]
[32m✔[0m MatrixModels 0.5-4                       [built from source in 31s]
[32m✔[0m numDeriv 2016.8-1.1                      [built from source in 8.2s]
[32m✔[0m cowplot 1.2.0                            [built from source in 1.1m]
[32m✔[0m minqa 1.2.8                              [built from source in 49s]
[32m✔[0m SparseM 1.84-2                           [built from source in 51s]
[32m✔[0m rbibutils 2.4.1                          [built from source in 1.4m]
[32m✔[0m nloptr 2.2.1                             [built from source in 2.2m]
[32m✔[0m urca 1.3-4                               [built from source in 34s]
[32m✔[0m timeDate 4052.112                        [built from source in 1.0m]
[32m✔[0m zoo 1.8-15                               [built from source in 30s]
[32m✔[0m Rdpack 2.6.6                             [built from source in 20s]
[32m✔[0m lmtest 0.9-40                            [built from source in 17s]
[32m✔[0m reformulas 0.4.4                         [built from source in 24s]
[32m✔[0m RcppEigen 0.3.4.0.2                      [built from source in 3.1m]
...
[32m✔[0m doBy 4.7.1                               [built from source in 16s]
[32m✔[0m pbkrtest 0.5.5                           [built from source in 7.0s]
[32m✔[0m car 3.1-5                                [built from source in 11s]
[32m✔[0m rstatix 0.7.3                            [built from source in 6.3s]
Successfully installed 29 packages in 400 seconds.
The following package(s) will be installed:
- bayestestR  [0.17.0]
- datawizard  [1.3.1]
- effectsize  [1.0.2]
...
# Downloading packages -------------------------------------------------------
[32m✔[0m performance 0.16.0                       [2.2 MB in 0.4s]
[32m✔[0m bayestestR 0.17.0                        [431 kB in 0.4s]
[32m✔[0m insight 1.5.0                            [1.1 MB in 0.46s]
[32m✔[0m effectsize 1.0.2                         [396 kB in 0.46s]
[32m✔[0m parameters 0.29.0                        [690 kB in 0.47s]
[32m✔[0m datawizard 1.3.1                         [449 kB in 0.47s]
Successfully downloaded 6 packages in 0.77 seconds.

# Installing packages --------------------------------------------------------
[32m✔[0m insight 1.5.0                            [built from source in 18s]
[32m✔[0m datawizard 1.3.1                         [built from source in 7.3s]
[32m✔[0m bayestestR 0.17.0                        [built from source in 7.6s]
[32m✔[0m performance 0.16.0                       [built from source in 22s]
[32m✔[0m parameters 0.29.0                        [built from source in 27s]
[32m✔[0m effectsize 1.0.2                         [built from source in 5.3s]
Successfully installed 6 packages in 65 seconds.
```
...
<img src="fig/t_tests_and_anova-rendered-excercise1-plot-1.png" alt="" style="display: block; margin: auto;" />
...
# A tibble: 1 × 6
  .y.   group1 group2     effsize     n magnitude 
* <chr> <chr>  <chr>        <dbl> <int> <ord>     
1 C3    1      null model -0.0225  1005 negligible
```

On average, respondents reported neutral satisfaction with their employer's support for flexible working arrangements (mean score 2.97 out of 5, t(1004) = -0.713, p = 0.476). We can be 95% confident the true average across the population falls between 2.88 and 3.06, meaning satisfaction is consistently, at the midpoint. This is also supported by the negligible effect reported by `Cohen's *d*` (-0.022).
...
Compare commute time in minutes (D1) between male and female respondents (A1).
Check Levene's test, run the appropriate t-test, and compute `Cohen's *d*`.
...
# A tibble: 1 × 4
    df1   df2 statistic      p
  <int> <int>     <dbl>  <dbl>
1     1  1003      4.33 0.0376
```

As p < 0.05, variances are not equal, so we should use `Welch's t-test`. 
...
1     3.53      72.8      69.2 D1    female male     583   422      2.00 0.046
...
# A tibble: 1 × 7
  .y.   group1 group2 effsize    n1    n2 magnitude 
* <chr> <chr>  <chr>    <dbl> <int> <int> <ord>     
1 D1    female male     0.128   583   422 negligible
```
...
"Female respondents reported slightly higher commute times to work (mean = 72.6 minutes, sd = 26.46) compared to male respondents (mean = 69.22, sd = 28.45), a difference of 3.53 minutes. This difference, while statistically significant (t(867) = 2.0, p = 0.046, 95% CI [0.10, 6.96]), represents a negligible practical effect (`Cohen's d` = 0.13). `Levene's test` confirmed that the two groups had equal variance (p = 0.969), so the `Student's t-test` was used."
:::
::::
