...
Let's start by looking at the sumary statistics
```{r wanova1-summary}
survey %>%
  group_by(A2) %>%
  summarise(
...
::: callout
## `MANOVA` vs `t-tests`
In the previous workshop, we used a variety of `t-test` to investigate various research questions related to C1 and C2 survey responses.
