...
for (by_var in demo_vars) { 
  ...
  tbl <- survey %>%
    ...
    # this code ensures the output renders on the website. Comment out the next 3 lines when running locally.
    as_gt() %>%
    gt::as_raw_html() %>%
    cat()
  
  #uncomment the line below to print the output locally
  print(tbl)
