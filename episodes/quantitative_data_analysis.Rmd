...
Дараа нь дараахыг ашиглан үүсгэсэн судалгааны дата багцыг татаж авна уу
код:
...
Дата фреймийг шалгаад R нь өгөгдлийн төрлүүдийг хэрхэн ангилж байсныг харцгаая.
...
Судалгаанд оролцогчид насны бүлгүүдэд хэрхэн хуваарилагдсан гэх мэт загварууд,
...
survey %>% 
  ...
  add_overall() %>% # adds total column
  bold_labels() %>% 
  modify_caption(glue::glue("**Stratified by A1**"))
```
...
survey %>% 
  ...
  add_overall() %>% # adds total column
  bold_labels()  %>% 
  modify_caption(glue::glue("**Stratified by A2**"))
```
...
survey %>% 
  ...
  add_overall() %>% # adds total column
  bold_labels()  %>% 
  modify_caption(glue::glue("**Stratified by A3**"))
...
survey %>% 
  ...
  add_overall() %>% # adds total column
  bold_labels()  %>% 
  modify_caption(glue::glue("**Stratified by A4**"))
```
...
survey %>% 
  ...
  add_overall() %>% # adds total column
  bold_labels()  %>% 
  modify_caption(glue::glue("**Stratified by A5**"))
```
...
survey %>% 
  ...
  add_overall() %>% # adds total column
  bold_labels()  %>% 
  modify_caption(glue::glue("**Stratified by A6**"))
```
...
Боловсруулсан өгөгдлийг судалж үзсэнийхээ дараа бид үүнийг `.rds` руу бичих болно, энэ нь бидний өгөгдлийг боловсруулахын тулд хийсэн бүх зүйлийг (хүчин зүйлийн түвшин ба дараалал, захиалгат анги, шинж чанар, баганын төрлүүд) хадгалдаг. Өгөгдлийг зөвхөн R-д ашиглах үед энэ нь хамгийн сайн сонголт юм.
...
Өнгөний өнгө нь чиглэлийг заадаг: цэнхэр эсүүд нь хоёр сонголтыг хамт сонгох хандлагатай байдаг бол улаан эсүүд нь нэг сонголтыг сонгох нь нөгөөг нь сонгохгүй байхтай холбоотой гэсэн үг юм. Өнгөний эрч хүч нь хүчийг кодлодог; бараан сүүдэр нь илүү хүчтэй холбоог, цайвар сүүдэр нь тэгтэй ойролцоо харилцааг илтгэнэ.
...
- Таны түүврийн хэмжээ боломжийн том байна (ерөнхий удирдамжийн хувьд n > 30).
:::
...
Хи-квадрат тестийг ашиглан **Судалгааны асуулт:** Эрэгтэй, эмэгтэй хүмүүс В1 асуултын 1-р сонголтыг адилхан сонгох боломжтой юу?
...
Өөрөөр хэлбэл, OR харьцуулж байна:
...
4. **p-утга**: гурван аравтын орон хүртэлх тодорхой утга (эсвэл < .001)
...
"Ажилчдын сайн сайхан байдал, ажил-амьдралын тэнцвэрт байдлыг сайжруулах"-ыг уян хатан ажлын бодлогын гол зорилго болгон сонгоход жендэр ихээхэн хамааралтай байсан (χ²(1) = 377.63, p < 0.001), нөлөөллийн хэмжээ ихтэй (Крамерын V = 0.615).

Эмэгтэй ажилчид эрэгтэй ажилчдаас (OR = 18.08, 95% CI [13.20, 25.04]) харьцуулахад энэ давуу талыг сонгох магадлал харьцангуй өндөр байсан нь эмэгтэй ажилчид эрэгтэй ажилчдаас энэ сонголтыг сонгох магадлал ойролцоогоор 18 дахин их байгааг харуулж байна. Энэхүү хүчтэй бөгөөд статистикийн хувьд бат бөх ялгаа нь ажилчдын сайн сайхан байдал, ажил амьдралын тэнцвэрт байдлыг сайжруулах нь эмэгтэй ажилтнуудын хувьд илүү тулгамдсан асуудал болохыг харуулж байна."
...
Хэд хэдэн Хи квадрат тестийг нэгэн зэрэг явуулах нь магадлалыг нэмэгдүүлдэг
...
"FDR засварын дараа жендэр нь "Ажилчдын сайн сайхан байдал, ажил-амьдралын тэнцвэрт байдлыг сайжруулах"-ыг уян хатан ажлын бодлогын гол зорилго болгон сонгоход ихээхэн хамааралтай хэвээр байсан (χ²(1) = 377.63, p_adj < 0.001), их хэмжээний нөлөөлөлтэй (Крамерийн V = 0.615).

Эмэгтэй ажилчид эрэгтэй ажилчдаас (OR = 18.08, 95% CI [13.20, 25.04]) харьцуулахад энэ давуу талыг сонгох магадлал харьцангуй өндөр байсан нь эмэгтэй ажилчид эрэгтэй ажилчдаас энэ сонголтыг сонгох магадлал ойролцоогоор 18 дахин их байгааг харуулж байна. Энэхүү хүчтэй бөгөөд статистикийн хувьд бат бөх ялгаа нь ажилчдын сайн сайхан байдал, ажил амьдралын тэнцвэрт байдлыг сайжруулах нь эмэгтэй ажилтнуудын хувьд илүү тулгамдсан асуудал болохыг харуулж байна."


### Хи-квадрат таамаглал амжилтгүй болсон үед - Фишерийн яг тест

Хэрэв хүлээгдэж буй эсийн тоо 5-аас доош байвал Хи квадратын ойролцоо тооцоолол найдваргүй болно. Энэ нь ихэвчлэн жижиг дэд бүлгүүдэд тохиолддог, тухайлбал бид бүс нутгийг (гурван түвшин, тэгш бус байж болзошгүй) боловсролтой (гурван түвшин) давах үед тохиолддог - зарим хослол ховор байж болно.
...
Чухал ач холбогдол бүхий Хи-квадрат тестийн дараа стандартчилагдсан үлдэгдэл нь аль нь болохыг хэлж өгдөг
...
p < 0.05) нь Хи квадратын "хувьаасаа илүү ихийг хийж" байгаа нүдийг тэмдэглэнэ.
