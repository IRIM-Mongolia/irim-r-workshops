...
дахин давтагдах боломжтой `R` код. Эдгээр нь дахин ашиглах боломжтой `R` функцүүдийн цуглуулга юм.
...
`R`-д зориулсан код болон баримт бичгийн ижил, сүүлийн үеийн хувилбарууд.
...
Багцууд нь бусад зүйлд суулгасан функцуудыг ашиглаж чаддаг (мөн хийдэг).
...
Багцын табыг доош гүйлгэж `tidyverse` руу очно уу. Та мөн цөөн хэдэн зүйлийг бичиж болно
...
маш хурдан эсвэл хэдэн минут болно. Суулгац үргэлжилж байх үед,
...
`pdf_document`, эсвэл `word_document`. Бид HTML-ээс эхэлнэ
...
`Visual` чихийг дарж `Markdown`-ийг, эсвэл `Source`-г дарж түүхийг нь үзнэ үү.
`Markdown`.

#### Гарчиг

Текстийн өмнө байрлах `#` нь `Markdown`-д энэ текст нь a
...
доогуур зураас, `___really___`; мөн, хэрэв та зоригтой санагдаж байвал (зохионгуй үг хэллэг)
...
Хэсэг оруулахын тулд `Insert` товчлуурын хажууд байгаа жижиг сумыг товшино уу
засварлагч хэрэгслийн мөрийг сонгоод `R`-г сонгоно уу.

Chunk ажиллуулахын тулд баруун талд байгаа жижиг ногоон тоглох сумыг дарна уу
хэсэг, эсвэл `Windows` дээр `Ctrl + Alt + I` (эсвэл `Mac` дээр `Cmd + Option + I`) гарын товчлолыг ашиглана уу.
...
Одоо бид хэд хэдэн зүйлийг сурсан тул энэ нь ашигтай байж магадгүй юм
...
Энэ өгөгдөл нь `SAFI Survey Results`-н бага зэрэг цэвэршүүлсэн хувилбар юм
дээр боломжтой
...
Баримт бичиг хараахан байгаа бол та **`preview`**-д орох үед үүнийг хийхийг сануулах болно
анх удаа.
...
<kbd>Ctrl</kbd>+<kbd>Alt</kbd>+<kbd>I</kbd> гарын товчлолыг ашиглан
`Windows` болон `Linux` дээр, мөн <kbd>Cmd</kbd>+<kbd>Сонголт</kbd>+<kbd>I</kbd>
`Mac` дээр.
...
хэсгийг эхлүүлж дуусгадаг (```` ``` ````) хэсгээс. Энэ нь бас мэддэг
Хэсэг доторх код нь `r` доторх R код байна
буржгар хаалт (`{}`). `r`-ийн дараа та кодын хэсэгт нэр нэмж болно
. Хэсэг хэсгийг нэрлэх нь сонголттой боловч санал болгож байна. Хэсэг бүр нэр байх ёстой
өвөрмөц бөгөөд зөвхөн үсэг, тоон тэмдэгт болон `-` агуулсан.
...
нь .Rmd баримт бичигтэй харьцангуй бөгөөд төслийн үндэс **биш**.
...
`Windows` болон `Linux` дээр <kbd>Ctrl</kbd>+<kbd>Alt</kbd>+<kbd>C</kbd>, эсвэл
`Mac` дээрх <kbd>Cmd</kbd>+<kbd>Сонголт</kbd>+<kbd>C</kbd>.
...
`{r eval = FALSE, echo = FALSE}`-р хэсэг үүсгээд дараа нь үүсгэ
...
`Markdown` хэсэгт ашиглагдаж, `r`-ээр биднийг байгаа гэдгийг зааж өгсөн
...
кодын гаралтыг бэлтгэх замаар шугаман гаралтыг гаргах хэрэгтэй
...
Эцэст нь бид бас талбайг оруулах тул бидний баримт бичиг арай илүү байна
...
`.pdf` баримт бичгийг үүсгэхийн тулд зарим нэмэлт программ хангамж суулгах шаардлагатай байж магадгүй.
...
Үүнийг зөвхөн нэг удаа хийх хэрэгтэй) дараа нь **`Knit`**-г pdf `tinytex`-д оруулах үед
