...
зөв ажиллахын тулд суулгаж байгаа бол өөр багцууд байж болно
...
байгаа бүх багцыг харах боломжтой болно
суулгасан.
:::
::::
...
хэсэг буюу `Windows` болон `Linux` дээр **`Ctrl+Alt+I`** гарын товчлолыг (эсвэл `Mac` дээр **`Cmd+Option+I`**) ашиглана уу.

#### Гаралтыг харж байна

Кодын хэсгийг ажиллуулсны дараа график эсвэл өгөгдөл зэрэг үр дүн гарна
...
GitHub линкээс эсвэл `R`-тай семинар. Та файлыг эндээс татаж авах боломжтой
...
`Markdown` синтаксийн дэлгэрэнгүй мэдээллийг [`the following reference guide`](https://www.markdownguide.org/basic-syntax) үзнэ үү.
...
**`tidyverse`**-г консолоос ачаал, бид үүнийг өөрийн дотор ачаалах шаардлагатай болно
...
`Windows` болон `Linux`, **`Cmd+Option+I`** дээр
`Mac` дээр.
...
.Rmd баримт бичигтэй харьцангуй бөгөөд төслийн үндэс **биш**.
...
хүснэгтийг харж, сонголт бүр гаралтад юу хийхийг харна уу.
...
R хэрэглэгчдэд илүү хялбар. `tinytex` суулгасан бол ажиллуул
