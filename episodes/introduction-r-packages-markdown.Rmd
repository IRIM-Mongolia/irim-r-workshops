...
## Installing packages using the console or packages tab
...
In the packages pane, search for the 'here' package and install it.
...
R Notebooks can be readily converted to multiple static and dynamic
output formats, including PDF (.pdf), Word (.docx), and HTML (.html).
